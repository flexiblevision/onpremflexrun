...
enabled_features argument to release/manifest.py:applicable(), the list of
containers the upgrade path should redeploy at the pinned digest, and the set of
licences to re-check.
